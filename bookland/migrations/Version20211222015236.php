 ...
 */
final class Version20211222015236 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE livre (id INT AUTO_INCREMENT NOT NULL, isbn VARCHAR(17) NOT NULL, titre VARCHAR(255) NOT NULL, nbpages INT NOT NULL, date_de_parution DATE NOT NULL, note SMALLINT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
